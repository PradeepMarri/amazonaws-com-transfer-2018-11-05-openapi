...
func CreateconnectorHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateConnectorRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=TransferService.CreateConnector", cfg.BaseURL)
		...
		var result models.CreateConnectorResponse
...
func CreateCreateconnectorTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=TransferService_CreateConnector",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateconnectorHandler(cfg),
	}
}
