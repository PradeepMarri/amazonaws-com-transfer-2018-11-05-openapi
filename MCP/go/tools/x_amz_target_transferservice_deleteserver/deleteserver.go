...
func DeleteserverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=TransferService.DeleteServer", cfg.BaseURL)
...
func CreateDeleteserverTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=TransferService_DeleteServer",
		mcp.WithDescription("<p>Deletes the file transfer protocol-enabled server that you specify.</p> <p>No response returns from this operation.</p>"),
